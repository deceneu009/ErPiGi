...
void Mage::LevelUpHero()
{
    ...
    if (Level == 4)
    {
        SetDefense(Defense * 2.5);
        SetMagicPower(MagicPower * 4);
        SetMagicResistance(MagicResistance * 4);
...
void Warrior::LevelUpHero()
{
    ...
    if (Level == 2)
    {
        ...
        SetMagicPower(MagicPower * 1.4);
        SetMagicResistance(MagicResistance * 1.4);
        SetPhysicalDamage(PhysicalDmg * 2);
        SetHp(hp * 2);
    }
    if (Level == 3)
    {
    ...
    if (Level == 4)
    {
        ...
        SetPhysicalDamage(PhysicalDmg * 3.8);
        SetHp(hp * 4);
    }
    if (Level == 5)
    {
        ...
        SetMagicResistance(MagicResistance * 5);
        SetPhysicalDamage(PhysicalDmg * 4.6);
        SetHp(hp * 5);
    }
    if (Level == 6)
    {
        SetDefense(Defense * 5.6);
    ...
    if (Level == 8)
    {
        SetDefense(Defense * 7.2);
        SetMagicPower(MagicPower * 6);
        SetMagicResistance(MagicResistance * 7);
        SetPhysicalDamage(PhysicalDmg * 8);
        SetHp(hp * 6);
    }
    if (Level == 9)
    {
        SetDefense(Defense * 8.5);
        SetMagicPower(MagicPower * 6.5);
        SetMagicResistance(MagicResistance * 7.6);
        SetPhysicalDamage(PhysicalDmg * 8.8);
        SetHp(hp * 7);
    }
    if (Level == 10)
    {
        SetDefense(Defense * 9.7);
        SetMagicPower(MagicPower * 7);
        SetMagicResistance(MagicResistance * 8);
        SetPhysicalDamage(PhysicalDmg * 10);
        SetHp(hp * 9);
    }
}
